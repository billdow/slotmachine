...
//  SlotMachine
//
//  Created by billdow on 12/28/14.
...
class ViewController: UIViewController {
    ...
    func setupThirdContainer(containerView: UIView) {
        ...
        self.creditsLabel.font = UIFont(name: "Menol-Bold", size: 16)
        ...
        self.betLabel.font = UIFont(name: "Menol-Bold", size: 16)
        ...
        self.winnerPaidLabel.font = UIFont(name: "Menol-Bold", size: 16)
        ...
        self.betTitleLabel.center = CGPoint(x: containerView.frame.width * 3, y: containerView.frame.height * 2)
